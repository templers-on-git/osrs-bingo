...
- **Slot-based set builder UI**: build item sets against a visual layout modeled on the in-game equipment interface (an "equipment doll") instead of a flat item list/dropdown — Liel can provide a reference screenshot when this is picked up.
